...
public class EMFBridge {
	...
	public static Evaluator getEvaluator(String bundleId, String module, Optional<ClassLoader> additionalLoader) {
		...
		if(additionalLoader.isPresent()) {
			eval.addClassLoader(additionalLoader.get());
		}
	...
	public static Evaluator getEvaluator(String bundleId, String module) {
		return getEvaluator(bundleId,module,Optional.empty());
	}
