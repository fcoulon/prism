...
/**
 * This is the item provider adapter for a {@link myfsm.Machine} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MachineItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 MyfsmPackage.Literals.MACHINE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addInitialPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Machine_initial_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Machine_initial_feature", "_UI_Machine_type"),
				 MyfsmPackage.Literals.MACHINE__INITIAL,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MyfsmPackage.Literals.MACHINE__STATES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MyfsmPackage.Literals.MACHINE__STATES,
				 MyfsmFactory.eINSTANCE.createState()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return MyfsmEditPlugin.INSTANCE;
	}
